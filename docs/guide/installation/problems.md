...
+ Disabled <class name="luya\admin\Module" prop="logoutOnUserIpChange" /> in your admin module config. See [example config](installation/structure)
+ Disabled secure connection check <class name="luya\traits\ApplicationTrait" prop="ensureSecureConnection" />. See [example config](installation/structure)
